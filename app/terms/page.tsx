      ...
      <main className="flex-1 px-4 py-10 sm:px-6 sm:py-14 lg:px-8">
        <div className="mx-auto max-w-6xl">
          ...
          <article className="rounded-[1.75rem] border border-gray-100 bg-white p-6 shadow-sm sm:p-10 lg:p-12">
            ...
            <h1 className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">Terms & Conditions</h1>
            <p className="mt-2 text-base text-gray-500">Last updated: August 2025</p>

            <div className="mt-10 space-y-8 text-base leading-8 text-gray-700">
              <section>
                <h2 className="mb-2 text-lg font-bold text-gray-900">1. Acceptance of Terms</h2>
              ...
              <section>
                <h2 className="mb-2 text-lg font-bold text-gray-900">2. Description of Service</h2>
              ...
              <section>
                <h2 className="mb-2 text-lg font-bold text-gray-900">3. User Accounts</h2>
              ...
              <section>
                <h2 className="mb-2 text-lg font-bold text-gray-900">4. Orders and Payments</h2>
              ...
              <section>
                <h2 className="mb-2 text-lg font-bold text-gray-900">5. Delivery</h2>
              ...
              <section>
                <h2 className="mb-2 text-lg font-bold text-gray-900">6. Prohibited Conduct</h2>
              ...
              <section>
                <h2 className="mb-2 text-lg font-bold text-gray-900">7. Limitation of Liability</h2>
              ...
              <section>
                <h2 className="mb-2 text-lg font-bold text-gray-900">8. Changes to Terms</h2>
                <p>We may update these Terms at any time. Continued use of the service after changes constitutes acceptance of the new Terms.</p>
              </section>

              <section>
                <h2 className="mb-2 text-lg font-bold text-gray-900">9. Contact</h2>
